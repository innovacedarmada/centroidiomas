    ...
    $(document).ready(function () {
        ...
        function initializeSlider(sliderClass, nextBtnClass, prevBtnClass, paginationClass) {
            const sliderInit = new Swiper(sliderClass, {
                loop: false, /*	El slider se repite en bucle.*/
                slidesPerView: 1, /*Solo muestra 1 slide a la vez.*/
                effect: "fade", /*Aplica transición tipo desvanecimiento.*/
                speed: 4000,/*Transición entre slides dura 4 segundos.*/
                autoplay: { /*Cada slide permanece visible 5 segundos.*/
                    delay: 5000,
